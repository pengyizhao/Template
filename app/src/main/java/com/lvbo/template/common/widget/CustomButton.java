...
public class CustomButton extends Button {
    ...
    public void setTypeface(Context context,String fontType) {
        if (!TextUtils.isEmpty(fontType)){
            ...
            }  else if(fontType.equals(context.getResources().getString(R.string.Apex_New_Light))){
                super.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/Apex_New_Light.otf"));
